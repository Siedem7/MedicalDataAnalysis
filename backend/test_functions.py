...
class tests(unittest.TestCase):
    ...
    def test_get_id_from_token(self):
        ...
        self.assertEqual('Signature expired. Please log in again.', get_id_from_token(test_expired_token),"Function returned wrong value!")
    ...
    def test_authorize_permissions(self):
        ...
        self.assertEqual((401, 'Invalid token.'),authorize_permissions(test_incorrect_token,permission),"Wrong return")
